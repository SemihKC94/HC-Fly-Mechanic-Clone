...
public class SKC_ConditionalHidePropertyDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        SKC_ConditionalHideAttribute condHAtt = (SKC_ConditionalHideAttribute)attribute;
    ...
    private bool GetConditionalHideAttributeResult(SKC_ConditionalHideAttribute condHAtt, SerializedProperty property)
    {
